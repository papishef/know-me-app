...
/////////////Return page/////////////
    return (
        <div className='page-wrapper'>
            ...
            {loading && <p className= "text-center" style={{zIndex: 9999, position: "absolute", top: 500, color: "white", fontFamily: "Cursive", fontSize: 20, fontWeight: 700}}>eating up your chats... privacy first</p>}
